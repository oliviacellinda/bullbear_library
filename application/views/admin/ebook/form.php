                        ...
                        <div class="col-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p class="card-description">Masukkan data paket ebook baru</p>
                                    <div class="col-md-6">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('form').submit(function(event) {
                ...
                if(nama == '' || deskripsi == '' || harga == '' || thumbnail.files.length == 0) {
                    ...
                    $.ajax({
                        type    : 'post',
                        url     : '<?=base_url('admin/ebook/tambah/proses');?>',
                        dataType: 'json',
                        data    : formData,
                        contentType : false,
                        processData : false,
                        ...
                        success : function(response) { console.log(response);
                            if(response.type == 'success') {
                                // window.location = '<?=base_url('admin/ebook/detail/');?>' + response.message;
                            }
                            else {
                                showAlert(response);
                            }
