                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mt-5 separator-line">
                                            ...
                                            <div class="d-flex flex-column align-items-top">
                                                ...
                                                <div class="mb-4 flex-grow">
                                                    <h5 class="mb-2">Link Tokopedia</h5>
                                                    <div class="ml-4 mb-0 font-weight-light">
                                                        <?=$ebook['link_ebook'];?>
                                                    </div>
                                                </div>
                        ...
                        <div class="col-12">
                            <form>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="link" id="link" class="form-control" autocomplete="off" value="<?=$ebook['link_ebook'];?>" placeholder="Masukkan link dengan format http://www.example.com">
